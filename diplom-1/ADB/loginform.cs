    ...
    public partial class Loginform : Form
    {
        ...
        private void vxod_Click(object sender, EventArgs e)
        {
            ...
            if (table.Rows.Count > 0)
            {
                ...
                if (cellValue.ToString() == "Админ") { perem.count = 1;gl(); }
                
                else if (cellValue.ToString() == "Менеджер") { perem.count = 2 ;gl(); }
                
                else if(cellValue.ToString() == "Продавец") { perem.count = 3;fa(); }

                else if (cellValue.ToString() == "Консультант") { 
                    perem.count = 4 ;
                    fa();
                }
                else 
